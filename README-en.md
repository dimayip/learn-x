...
└── references/
    ...
    └── session-patterns.md                # Adapted workflows for concept / tool / skill / judgment / mindset learning
```
...
- **[`references/session-patterns.md`](./references/session-patterns.md)** — How to shape a session differently for concept learning vs. tool onboarding vs. skill building vs. problem-solving vs. mindset change.
